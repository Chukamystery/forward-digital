...
.gdnav-circle-1, .gdnav-circle-4, .gdnav-circle-, .gdnav-circle-2 {
    background: #000;
}
...
@media only screen and (max-width: 600px){
#start {
width:200px !important;height:60px !important;padding-left: 10px !important;padding-right: 10px !important;border-radius:30px !important;
}}
@media only screen and (max-width: 1024px){
#start {
width:400px !important;height:60px !important;padding-left: 100px !important;padding-right: 100px !important;border-radius:30px !important;
}
}
...
<?php include('../nav.php'); ?>
    <!-- END nav -->
    <div class="normalizer1" style="background-color: #000 !important; width:auto;"></div>
 
   
  
    
    <section class="ftco-section bg-light" style="background-color: #696969 !important;">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-5" style="padding-bottom:0px !important;padding-top:0px !important;margin-bottom:0px !important;margin-bottom:0px !important;">
          <div class="col-md-7 text-center heading-section ftco-animate" style="padding-bottom:0px !important;padding-top:0px !important;margin-bottom:0px !important;margin-bottom:0px !important;">
            <h1 class="mb-3"><strong><b style="">Our Best Pricing</b></strong></h1>
            <span class="subheading" style="font-size:15px !important;color:#fff">Our pricing is budget friendly. Choose a pricing that suits your budget.</span>
          </div>
        </div>
    		<div class="row">
	        <div class="col-md-3 ftco-animate" >
	          <div class="block-7" style="border-radius:8px; border:2px green solid">
		...
		<article>
             <div class="row justify-content-center mb-5 pb-5" style="padding-bottom:0px !important;padding-top:0px !important;margin-bottom:0px !important;margin-bottom:0px !important;">
          <div class="col-md-7 text-center heading-section ftco-animate" style="padding-bottom:0px !important;padding-top:0px !important;margin-bottom:0px !important;margin-bottom:0px !important;">
            <h1 class="mb-3"><strong><b style="">Frequently asked questions</b></strong></h1>
          </div>
        </div>
			<ul class="accordion">
				<li class="accordion__item" style="border:2px solid green !important">
					<a  class="accordion__link accordion__link_active">What do you mean by design options?</a>
					<ul class="sub-accordion">
						<li class="sub-accordion__item">Design options are the different designs created for you to make a choice.</li>
<!--
...
-->
				...
				<li class="accordion__item" style="border:2px solid green !important">
					<a  class="accordion__link">What are unlimited revisons?</a>
					<ul class="sub-accordion">
						<li class="sub-accordion__item">Revisions are the changes or modifications made on a design; unlimited revisions means you can make as many modification as possible until you are satisfied with the designs. No extra fee.</li>
<!--
						<li class="sub-accordion__item">Типы данных, значения и переменные</li>
						<li class="sub-accordion__item">Выражения и операторы инструкции</li>
-->
				...
				<li class="accordion__item" style="border:2px solid green !important">
					<a  class="accordion__link">What do you mean by animations?</a>
					<ul class="sub-accordion">
						<li class="sub-accordion__item">Logo animation is a motion introduction of your logo design.</li>
					</ul>
				</li>
				<li class="accordion__item" style="border:2px solid green !important">
					<a  class="accordion__link">What do you mean by animations?</a>
    	...
    	<div class="container" style="padding-bottom:50px">
          <div class="row d-flex justify-content-center ftco-animate">
                       <a href="../project-brief/" id="start" class="btn btn-primary py-3 px-5"  style="background-color:blue;color:white"><span class="wave">👋</span>&nbsp;<span style="text-align:center;height:100px">START A PROJECT WITH US</span></a>
          </div>
        </div>
        </div>
    </section>
